...
STEP_WIDTH_X = 1.6    # X direction (1.73 - 0.14), meters
...
STAIR_START_Y = -0.15   #-0.05 #-0.08 #-0.21  # where the first step begins (terrain-local, +Y side)
STAIR_CENTER_X = 1.1   #1.0 #1.15 # X coordinate (terrain-local) of the staircase center
