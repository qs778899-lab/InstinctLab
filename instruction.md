...
### 运行指令：
    ...
    ****训练配置****：
    ...
    python scripts/instinct_rl/play.py --task=Instinct-Perceptive-Shadowing-G1-Play-v0 --load_run 20260323_234039 --num_envs 1 --checkpoint model_42000.pt
