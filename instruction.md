...
### 运行指令：
    ...
    python scripts/amass_visualize.py --num_envs 1 --motion_path "/home/huangyucheng/桌面/Project Instinct/InstinctLab/MOTION_data/test_motion_data_stairs_3.0/stairs146_augmented_interp_retargeted.npz" --print_foot_pos --print_interval 20 --print_foot_pos
    ...
    python scripts/instinct_rl/play_vis.py --task=Instinct-Perceptive-Shadowing-G1-Play-v0 --load_run 20260319_115839 --num_envs 1 --freeze_policy --viewer_eye 5.8 0.6 0.2  --viewer_lookat 0.0 0.0 0.5  --motion_file "/home/huangyucheng/桌面/Project Instinct/InstinctLab/MOTION_data/test_motion_data_stairs_3.0/stairs_01_original_interp_retargeted.npz" 

    python scripts/instinct_rl/play_vis.py --task=Instinct-Perceptive-Shadowing-G1-Play-v0 --load_run 20260319_115839 --num_envs 1 --freeze_policy --viewer_eye 5.8 0.6 0.2  --viewer_lookat 0.0 0.0 0.5  --motion_file "/home/huangyucheng/桌面/Project Instinct/InstinctLab/MOTION_data/test_motion_data_stairs_3.0/stairs146_augmented_interp_retargeted.npz" 
    ...
    ****训练配置****：
    ...
    # climb300 (STAIR_START_Y = -0.05)
    python scripts/instinct_rl/play.py --task=Instinct-Perceptive-Shadowing-G1-Play-v0 --load_run 20260327_224229 --num_envs 1 --checkpoint model_50000.pt --motion_file stairs_01_original_retargeted.npz
    python scripts/instinct_rl/play.py --task=Instinct-Perceptive-Shadowing-G1-Play-v0 --load_run 20260327_224229 --num_envs 1 --checkpoint model_50000.pt --interactive
...
-----------------------------------------------------------------------------------------------------------
    ...
    含义：在一次 PPO 收集窗口里，所有结束了的 episode 的 “每步 reward（由 robot vs 该 episode 抽到的 reference motion 对齐而得）求和” 的平均值。（Train/mean_reward_0：横轴是 current_learning_iteration（第几次 PPO 更新）。Train/time/mean_reward_0：横轴是 tot_time（从训练开始算起的累计墙钟时间，秒）。）
