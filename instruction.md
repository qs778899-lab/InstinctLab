...
### 运行指令：
    ...
    python scripts/instinct_rl/play_vis.py --task=Instinct-Perceptive-Shadowing-G1-Play-v0 --load_run 20260319_115839 --num_envs 1 --freeze_policy --viewer_eye 5.8 0.0 0.2  --viewer_lookat 0.0 0.0 0.5
    ...
    ****训练配置****：
    ...
    python scripts/instinct_rl/train.py --task=Instinct-Perceptive-Shadowing-G1-v0 --headless --resume --load_run 20260319_115839
    ...
    python scripts/instinct_rl/play.py --task=Instinct-Perceptive-Shadowing-G1-Play-v0 --load_run 20260318_231039 --num_envs 1 --checkpoint model_5000.pt
    python scripts/instinct_rl/play.py --task=Instinct-Perceptive-Shadowing-G1-Play-v0 --load_run 20260319_115839 --num_envs 1
