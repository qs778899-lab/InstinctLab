...
### 运行指令：
    ...
    python scripts/amass_visualize.py --num_envs 1 --motion_path "/home/huangyucheng/桌面/Project Instinct/InstinctLab/MOTION_data/test_motion_data_stairs/stairs011_retargeted.npz" --print_foot_pos --print_interval 20 --print_foot_pos
    ...
    python scripts/amass_visualize.py --num_envs 1 --motion_path "/home/huangyucheng/桌面/Project Instinct/InstinctLab/MOTION_data/test_motion_data_walk/" --interactive 
    ...
    # 训练
    python scripts/instinct_rl/train.py --task=Instinct-Perceptive-Shadowing-G1-v0  --headless 'env.scene.motion_reference.motion_buffers.TerrainMotion.motion_start_from_middle_range=[0.0,0.0]' env.scene.motion_reference.motion_buffers.TerrainMotion.fix_origin_index=0 

    --resume --load_run 20260323_ --checkpoint model_.pt
    ...
    ****训练配置****：
    ...
    # 恢复训练，自动加载最新的 checkpoint （指定具体的权重文件： --checkpoint model_2000.pt）
    python scripts/instinct_rl/train.py --task=Instinct-Perceptive-Shadowing-G1-v0 --headless --resume --load_run 20260321_133120
    ...
    python scripts/instinct_rl/play.py --task=Instinct-Perceptive-Shadowing-G1-Play-v0 --load_run 20260322_175243 --num_envs 1 --checkpoint model_48000.pt
